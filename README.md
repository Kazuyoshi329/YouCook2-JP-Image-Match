...
### Step 2: Keyframe Selection via CLIP 
<!--
CLIPによる最適な1枚の選出
-->
...
動画形式の混同について:
-->
The downloaded videos may contain both .mp4 and .mkv formats. Please ensure all videos are converted into .mp4 format before running the scripts.
<!--
...
パスの書き換えについて
-->
Please modify the directory paths in the scripts to match your local environment where the downloaded videos are stored.
<!--
